            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">TripBooking {{ $tripbooking->id }}</h4><br>
                                ...
                                <div class="row file-upload" style="display: none;">
                                    <div class="col-md-6 offset-3">
                                        <div class="card">
                                            <div class="card-body">
                                                @if(app()->getLocale() == 'ur')
                                                <form method="POST" action="/ur/ship-check-out-submit" class="form-horizontal" enctype="multipart/form-data" id="ship-check-out">
                                            @elseif(app()->getLocale() == 'ar')
                                                <form method="POST" action="/ar/ship-check-out-submit" class="form-horizontal" enctype="multipart/form-data" id="ship-check-out">
                                            @else
                                                <form method="POST" action="/ship-check-out-submit" class="form-horizontal" enctype="multipart/form-data" id="ship-check-out">
                                            @endif
