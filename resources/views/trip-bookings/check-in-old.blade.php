                                ...
                                <div class="row file-upload" style="display: none;">
                                    <div class="col-md-6 offset-3">
                                        <div class="card">
                                            <div class="card-body">
                                                @if(app()->getLocale() == 'ur')
                                                    {!! Form::open(['url' => '/ur/check-in-submit', 'class' => 'form-horizontal', 'files' => true, 'id' => 'check-in']) !!}
                                                @elseif(app()->getLocale() == 'ar')
                                                    {!! Form::open(['url' => '/ar/check-in-submit', 'class' => 'form-horizontal', 'files' => true, 'id' => 'check-in']) !!}
                                                @else
                                                    {!! Form::open(['url' => '/check-in-submit', 'class' => 'form-horizontal', 'files' => true, 'id' => 'check-in']) !!}
                                                @endif
                                                @method('post')
