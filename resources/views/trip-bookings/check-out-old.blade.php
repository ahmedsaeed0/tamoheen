        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a  href="{{ url('/trip-bookings') }}" class="btn btn-primary"> Back</a>
                                ...
                                <div class="row file-upload" style="display: none;">
                                    <div class="col-md-6 offset-3">
                                        <div class="card">
                                            <div class="card-body">
                                                @if(app()->getLocale() == 'ur')
                                                    {!! Form::open(['url' => '/ur/check-out-submit', 'class' => 'form-horizontal', 'files' => true, 'id' => 'check-out']) !!}
                                                @elseif(app()->getLocale() == 'ar')
                                                    {!! Form::open(['url' => '/ar/check-out-submit', 'class' => 'form-horizontal', 'files' => true, 'id' => 'check-out']) !!}
                                                @else
                                                    {!! Form::open(['url' => '/check-out-submit', 'class' => 'form-horizontal', 'files' => true, 'id' => 'check-out']) !!}
                                                @endif
