                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show" id="paytab" role="tabpanel" aria-labelledby="pills-one-example2-tab">
                                    <div class="row justify-content-around">
                                        <div class="card">
                                            <div class="card-body">
                                                <a href="{{ url('ship-paytab-payment/'.$tripbooking->id) }}">@lang('content.paytabs')</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mx-auto">
                                        @if(app()->getLocale() == 'ur')
                                            <form class="js-validate pt-3" action="{{ url('ur/ship-paytab-payment-submit') }}" method="POST">
                                        @elseif(app()->getLocale() == 'ar')
                                            <form class="js-validate pt-3" action="{{ url('ar/ship-paytab-payment-submit') }}" method="POST">
                                        @else
                                            <form class="js-validate pt-3" action="{{ url('ship-paytab-payment-submit') }}" method="POST">
                                        @endif
                                            @csrf
                                            <div class="row">
                                                <!-- Input -->
                            ...
                            <div class="tab-pane fade show active" id="stc" role="tabpanel" aria-labelledby="pills-one-example2-tab">
                                ...
                                @if(app()->getLocale() == 'ur')
                                    <form class="js-validate pt-3" action="{{ url('ur/stc-ship-payment-submit') }}" method="POST">
                                @elseif(app()->getLocale() == 'ar')
                                    <form class="js-validate pt-3" action="{{ url('ar/stc-ship-payment-submit') }}" method="POST">
                                @else
                                    <form class="js-validate pt-3" action="{{ url('stc-ship-payment-submit') }}" method="POST">
                                @endif
                                    ...
                                    <div class="col-md-6 mx-auto">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" class="form-control" name="shipment_booking_id" required value="{{ Crypt::encrypt($tripbooking->id) }}">
                                                <!-- End Input -->
                            ...
                            <div class="tab-pane fade show" id="telr" role="tabpanel" aria-labelledby="pills-one-example2-tab">
                                <div class="row justify-content-around">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="{{ url('telr-ship-payment/'.$tripbooking->id) }}">@lang('content.telr')</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mx-auto">
                                        @if(app()->getLocale() == 'ur')
                                            <form class="js-validate pt-3" action="{{ url('ur/telr-ship-payment-submit') }}" method="POST">
                                        @elseif(app()->getLocale() == 'ar')
                                            <form class="js-validate pt-3" action="{{ url('ar/telr-ship-payment-submit') }}" method="POST">
                                        @else
                                            <form class="js-validate pt-3" action="{{ url('telr-ship-payment-submit') }}" method="POST">
                                        @endif
                                            @csrf
                                            <div class="row">
                                                <!-- Input -->
