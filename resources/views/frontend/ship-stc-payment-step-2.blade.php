                    ...
                    <div class="pt-4 pb-5 px-5">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="stc" role="tabpanel" aria-labelledby="pills-one-example2-tab">
                                ...
                                @if(app()->getLocale() == 'ur')
                                    <form class="js-validate pt-3" action="{{ url('ur/direct-stc-ship-payment-confirm') }}" method="POST">
                                @elseif(app()->getLocale() == 'ar')
                                    <form class="js-validate pt-3" action="{{ url('ar/direct-stc-ship-payment-confirm') }}" method="POST">
                                @else
                                    <form class="js-validate pt-3" action="{{ url('direct-stc-ship-payment-confirm') }}" method="POST">
                                @endif
                                    @csrf
                                <div class="row pt-3">
                                    <div class="col-md-6 mx-auto">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" class="form-control" name="ship_booking_id" required value="{{ Crypt::encrypt($trip_booking->id) }}">
