                ...
                <div class="mb-5 shadow-soft bg-white rounded-sm">
                    ...
                    <div class="pt-4 pb-5 px-5">
                        ...
                        @if(app()->getLocale() == 'ur')
                            ...
                            <form class="js-validate" action="{{ url('ur/review-submit') }}" method="POST">

                        @elseif(app()->getLocale() == 'ar')

                            <form class="js-validate" action="{{ url('ar/review-submit') }}" method="POST">

                        @else

                            <form class="js-validate" action="{{ url('review-submit') }}" method="POST">
                        ...
                        @endif
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="trip_booking_id" value="{{ $tripbooking->id }}">
