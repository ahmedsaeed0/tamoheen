                    ...
                    <div class="pt-4 pb-5 px-5">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="stc" role="tabpanel" aria-labelledby="pills-one-example2-tab">
                                ...
                                @if(app()->getLocale() == 'ur')
                                    <form class="js-validate pt-3" action="{{ url('ur/direct-stc-product-payment-confirm') }}" method="POST">
                                @elseif(app()->getLocale() == 'ar')
                                    <form class="js-validate pt-3" action="{{ url('ar/direct-stc-product-payment-confirm') }}" method="POST">
                                @else
                                    <form class="js-validate pt-3" action="{{ url('direct-stc-product-payment-confirm') }}" method="POST">
                                @endif
                                    @csrf
                                <div class="row pt-3">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                {{-- <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="token_ref" placeholder="Enter Token Reference Number" id="mobile" value="{{ Crypt::encrypt($order->id) }}">
                                                {{-- </div> --}}

                                                <input type="hidden" class="form-control" name="order_id" required value="{{ Crypt::encrypt($order->id) }}">
