...
<script src="{{ asset('front/assets/vendor/gmaps/gmaps.min.js') }}"></script>
<script src="{{ asset('front/assets/vendor/player.js/dist/player.min.js') }}"></script>
<script src="{{ asset('front/assets/vendor/svg-injector/dist/svg-injector.min.js') }}"></script>
<script src="{{ asset('front/assets/vendor/fancybox/jquery.fancybox.min.js') }}"></script>
<script src="{{ asset('front/assets/vendor/ion-rangeslider/js/ion.rangeSlider.min.js') }}"></script>
...
<script src="{{ asset('front/assets/js/components/hs.validation.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.show-animation.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.range-datepicker.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.selectpicker.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.range-slider.js') }}"></script>
...
<script src="{{ asset('front/assets/js/components/hs.g-map.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.video-player.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.svg-injector.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.scroll-nav.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.sticky-block.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.fancybox.js') }}"></script>
<script src="{{ asset('front/assets/js/components/hs.focus-state.js') }}"></script>
<script src="{{ asset('front/assets/js/slider-cus.js') }}"></script>
...
<script>
    ...
    $(window).on('load', function () {
        ...
        // if(isMobile()){
        //     var url = "{{ env('MOBILE_REDIRECT_URL') }}";
