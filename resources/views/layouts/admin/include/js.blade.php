...
<script src="{{ asset('admin/assets/js/plugins/bootstrap-datetimepicker-2.min.js') }}"></script>
...
<!--  Google Maps Plugin    -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCjayEj5DRcHr0fSxVadApgBG3nE7jgyg&libraries=places"></script>
<!-- Chartist JS -->
